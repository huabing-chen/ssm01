 ...
 */
function login() {
    return location.href = "http://sso.qtu.com/page/login";
}
function regist() {
    return location.href = "http://sso.qtu.com/page/register";
}
...
function search(a) {
//    var b = "http://127.0.0.1:18017/search?q=" + encodeURIComponent(document.getElementById(a).value);
	var b = "http://protal.qtu.com/search?q=" + encodeURIComponent(document.getElementById(a).value);
