		...
		<%-- if(<%=user_id%>!=user_id){
			...
			$.ajax({
				...
				data : {
					...
					"result" : result,
					"faqipeople" : faqipeople
					
				},
				url : "../../ssm01/todolist/todalistAdd",
				dataType : "json",
				async : true,
	...
	<form action="DothingServlet.do" role="form" method="post"
		...
		<div class="user_left">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<input name="faqipeople" id="faqipeople" type="text" value=""
						placeholder="请输申报人姓名" lay-verify="required" class="layui-input">
				</div>
			</div>
			<!-- <div class="layui-form-item">
