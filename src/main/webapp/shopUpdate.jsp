...
<script type="text/javascript">
	...
	$(function(){
		...
		var userIdEidt = localStorage.getItem("shopId");
		/* alert(userIdEidt); */
		localStorage.setItem("shopId","0");
		$.ajax({
			type:"GET",
	    	   url:"../../ssm01/shop/updateshop",
	    	   dataType:"json",
				async:true,
				data : {"shopId":userIdEidt},
	...
	function updateAjax() {
		...
		$.ajax({
			...
			url : "../../ssm01/shop/shopUpdateTiJiao",
			dataType : "json",
			async : true,
			success : function(data) {
				if (data.status == "1") {
		...
		<div class="user_left">
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<input name="shopname" id="shopname" type="text" value="${shop.shopname }"
					disabled	placeholder="请输入商品名" lay-verify="required" class="layui-input">
				</div>
			</div>
			<div class="layui-form-item">
				<label class="layui-form-label">商品价格</label>
				<div class="layui-input-block">
					<input name="shopprice" id="shopprice" type="text" value="${shop.shopprice }"
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<input name="shopsize" id="shopsize" type="text" value="${shop.shopsize }" placeholder="请输入密码"
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<input name="shopnum" id="shopnum" type="text" value="${shop.shopnum }"
